...
public class RecycleViewAdapter_Film_ListaPreferiti extends RecyclerView.Adapter<RecycleViewAdapter_Film_ListaPreferiti.MyViewHolder> {
    ...
    public RecycleViewAdapter_Film_ListaPreferiti(Context mContext, List<ItemFilm> filmList, RecycleViewAdapter_Film_ListaPreferiti.OnClickListener mOnClickListener, boolean proprietario){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(!proprietario) {
            holder.rimuoviDaLista.setVisibility(View.INVISIBLE);
            holder.rimuoviText.setVisibility(View.INVISIBLE);
        }else{
            holder.rimuoviDaLista.setVisibility(View.VISIBLE);
            holder.rimuoviText.setVisibility(View.VISIBLE);
        }
